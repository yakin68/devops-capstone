...
resource "aws_iam_instance_profile" "petclinic-master-server-profile2" {
  name = "petclinic-master-server-profile2"
...
resource "aws_instance" "kube-master" {
    ...
    iam_instance_profile = aws_iam_instance_profile.petclinic-master-server-profile2.name
